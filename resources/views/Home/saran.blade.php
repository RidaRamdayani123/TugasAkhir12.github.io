      ...
      <div class="row">
        <div class="col-md-3">
          <div class="info_menu">
            ...
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="kepsek">Profil</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/login"> PPDB Online </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="event"> Galery </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="saran">Kontak</a>
              </li> 
        ...
        <div class="col-md-3">
          <div class="info_course">
            ...
            <p>
              Beroperasi pada hari kerja Senin sampai Sabtu, 
              Pukul 07:00 - 11:00
            </p>
          </div>
        </div>
        ...
        <div class="col-md-5 offset-md-1">
          <div class="info_news">
            ...
            <p>
              Sekolah Kita, Sekolah yang sangat kita cintai
            </p>
