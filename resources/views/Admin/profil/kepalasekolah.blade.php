        ...
        <div class="right_col" role="main">
          <div class="page-title">
              <div class="title_left">
                  ...
                  <a href="/tambahkepsek" class="btn btn-success">Tambah +</a>
              </div>
          </div>
          <table class="table">
              <thead>
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                          <img src="{{ asset('Fotokepsek/'.$row->foto) }}" alt="" style="width:60px;">
                      </td> 
                      <td>{{ $row->Jabatan }}</td>
                      <td>{{ $row->keterangan }}</td>
                      <td> 
                          <a href="/deletekepsek/{{ $row->id }}" class="btn btn-danger">Delete</a>
                      </td>
                  </tr>
                  @endforeach
              </tbody>
